        ...
        for seed in seeds:
            ...
            if experiment == 'obstacle_avoidance':
                plot_boxplot(
                    ...
                    "Collisions", f"Experiment {experiment} Seed {seed}",
    ...
    for experiment in experiments:
        for seed in seeds:
            for agent in agents:
                ...
                plot_time_series(data, 'Distance', f"Experiment {experiment} Seed {seed} Agent {agent}",
                                 f"charts/{experiment}_seed_{seed}_agent_{agent}_distance.pdf")
                plot_time_series(data, 'Hits', f"Experiment {experiment} Seed {seed} Agent {agent}",
